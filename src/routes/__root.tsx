...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "ConnectHub" },
      { property: "og:title", content: "ConnectHub — Gerencie conexões, contatos e conversas em um só lugar" },
      { property: "og:description", content: "SaaS completo para times: conexões WhatsApp, sync com Google Contacts, chat em tempo real, auditoria e mais. Auto-hospedável." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ConnectHub — Gerencie conexões, contatos e conversas em um só lugar" },
      { name: "twitter:description", content: "SaaS completo para times: conexões WhatsApp, sync com Google Contacts, chat em tempo real, auditoria e mais. Auto-hospedável." },
